...
def consulta_cpf():
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if dados.get("nome"):
                print("\n[+] Dados encontrados via BrasilAPI")
                print("\n╔══════════════════════════════════════════╗")
    ...
    if not dados_encontrados:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if dados.get("status") == "1" and dados.get("nome"):
                    print("\n[+] Dados encontrados via 4Devs")
                    print("\n╔══════════════════════════════════════════╗")
                    print("║           RESULTADO DA CONSULTA         ║")
                    print("╠══════════════════════════════════════════╣")
                    ...
                    campos = [
                        ...
                        ("Nome da Mãe", dados.get("nome_mae")),
                        ("Nome do Pai", dados.get("nome_pai")),
                        ("Situação", dados.get("situacao_cpf"))
                    ]
    ...
    if not dados_encontrados:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if dados.get("nome") and not dados.get("erro"):
                    print("\n[+] Dados encontrados via ReceitaWS")
                    print("\n╔══════════════════════════════════════════╗")
                    print("║           RESULTADO DA CONSULTA         ║")
                    print("╠══════════════════════════════════════════╣")
    ...
    # ==========================================
    # TENTATIVA 4: Havell Alldata
    # ==========================================
    if not dados_encontrados:
        print("\n[~] Tentando Havell Alldata...")
        try:
            ...
            if response.status_code == 200:
                ...
                if dados.get("status") == "success" and dados.get("nome_completo"):
                    print("\n[+] Dados encontrados via Havell Alldata")
                    print("\n╔══════════════════════════════════════════╗")
                    print("║           RESULTADO DA CONSULTA         ║")
                    print("╠══════════════════════════════════════════╣")
    ...
    if not dados_encontrados:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if dados.get("nome"):
                    print("\n[+] Dados encontrados via CPFReais")
                    print("\n╔══════════════════════════════════════════╗")
                    print("║           RESULTADO DA CONSULTA         ║")
                    print("╠══════════════════════════════════════════╣")
    ...
    # ==========================================
    if not dados_encontrados:
        print("\n[!] Nenhuma API retornou dados completos.")
        print("\n╔══════════════════════════════════════════╗")
        ...
        print("\n[i] Motivos da falha:")
        print("    1. APIs gratuitas com limite diário")
        print("    2. CPF não encontrado nas bases públicas")
